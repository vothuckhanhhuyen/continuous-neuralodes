...
class NODElayer(nn.Module):
    def __init__(self, df, args, evaluation_times=(0.0, 1.0), algebraic_from_differential=False, nesterov_factor=3, actv_k=None, actv_output=None, method="dopri5", step_size=None, differential_from_algebraic=False):
