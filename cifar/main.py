...
def main(argv=None):
    ...
    if args.model == 'node':
        ...
        iv = models.initial_velocity(3, dim, hidden)
        evaluation_times = (1.0, 2.0)
        model_layer = models.NODElayer(models.NesterovNODE(df, thetaact=None), evaluation_times=evaluation_times, args=args, algebraic_from_differential=True, differential_from_algebraic=True)
        ...
        model_layer = models.NODElayer(models.NesterovNODE(df, thetaact=tanh_act, xi=args.xi, nesterov_factor=nesterov_factor, actv_df=tanh_act), evaluation_times=evaluation_times, args=args, algebraic_from_differential=True, nesterov_factor=nesterov_factor, actv_k=tanh_act)
        ...
        method = "euler"
        step_size = 0.5
        model_layer = models.NODElayer(models.NesterovNODE(df, thetaact=tanh_act, xi=1.5, actv_df=tanh_act), evaluation_times=evaluation_times, args=args, algebraic_from_differential=True, differential_from_algebraic=True, nesterov_factor=args.nesterov_factor, actv_k=tanh_act, method=method, step_size=step_size)
